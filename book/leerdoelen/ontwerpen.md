...
### Decision (beslissing)
Na de evaluatie wordt besloten of het ontwerp *klaar* is, of dat er nog iets veranderd moet worden (en dus een iteratie, zie hieronder). Vaak gaan de evaluatie en de decision naadloos in elkaar over, vaak in dezelfde vergadering. Dat is niet altijd het geval: bij grote projecten kan het zijn dat de evaluatie tot een advies-rapport leidt en dat de beslissing genomen wordt door andere mensen. Bijvoorbeeld de opdrachtgever zelf. Het is aan te raden om de decision altijd schriftelijk vast te leggen.
